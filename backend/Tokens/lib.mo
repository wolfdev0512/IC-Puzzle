...
module {
    ...
    public class Factory (state : Types.State) {
        ...
        func _accountId(principal: Principal, subaccount: ?Ext.SubAccount): Ext.AccountIdentifier {
        ...
        public func _isOwner(caller: Ext.AccountIdentifier, tokenIndex: Ext.TokenIndex): Bool {
        ...
        public func _mint(tokenIndex: Ext.TokenIndex, to: Ext.User, subaccount: ?Ext.SubAccount): Result.Result<(), Text> {
        ...
        public func shuffleMetadata(caller: Principal): async () {
        ...
        // @auth: admin
        public func mint(caller: Principal, to: Ext.User): async Result.Result<(Nat), Text> {
        ...
        // @auth: admin
        public func configureMetadata(caller: Principal, conf: [Types.Metadata]): Result.Result<(), Text> {
            assert(state._Admins._isAdmin(caller));
        ...
        // @auth: admin
        public func backup(caller : Principal): Types.LocalStableState {
            assert(state._Admins._isAdmin(caller));
            toStable();
        };
        ...
        // @auth: admin
        public func restore(caller: Principal, backup: Types.LocalStableState): Result.Result<(), Text> {
            _restore(backup);
            #ok();
        };
        ...
        public func transfer (tokenIndex: Ext.TokenIndex, caller: Ext.AccountIdentifier, to: Ext.AccountIdentifier): () {
        ...
        public func tokenId(canister: Principal, index: Ext.TokenIndex): Ext.TokenIdentifier {
